...
public class UserController {
    ...
    public String createConfirm(@Validated({ Default.class,
            UserForm.UserCreateGroup.class }) UserForm form, BindingResult result) {
        if (result.hasErrors()) {
            return "user/createForm";
        }
    ...
    public String create(
            @Validated({ Default.class, UserForm.UserCreateGroup.class }) UserForm form,
    ...
    @RequestMapping(value = "updateByEmail", method = RequestMethod.GET)
    public String updateHeader(@RequestParam("email") String Email, UserForm form,
                             Model model) {
    ...
    public String updateConfirm(@Validated({ Default.class,
            UserForm.UserUpdateGroup.class }) UserForm form, BindingResult result) {
        if (result.hasErrors()) {
            return "user/updateForm";
        }
    ...
    public String update(
            @Validated({ Default.class, UserForm.UserUpdateGroup.class }) UserForm form,
            BindingResult result) {
        if (result.hasErrors()) {
            return "user/updateForm";
        }
    ...
    public String delete(
            @Validated({ Default.class, UserForm.UserDeleteGroup.class }) UserForm form,
